...
```
git submodule add https://github.com/xryuseix/CubismWebSamples CubismWebSamples
cd CubismWebSamples && git submodule add https://github.com/Live2D/CubismWebFramework Framework
```
